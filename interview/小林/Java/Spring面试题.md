---
title: "Spring面试题"
source: "https://www.xiaolincoding.com/interview/spring.html#spring"
author:
  - "[[小林coding]]"
created: 2026-05-08
tags:
...
Spring AOP 是基于 JDK 动态代理和 Cglib 字节码增强实现的，两种代理方式都属于运行时的一个方式，所以它没有编译时的一个处理，那么因此 Spring 是通过 Java 代码实现的。
