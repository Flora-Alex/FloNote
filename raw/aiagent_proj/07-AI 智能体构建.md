...
ReAct 流程如图：
![[Pasted image 20260507135054.png]]
示例实现代码：
...
- Claude 支持 Compute Use：[https://docs.anthropic.com/en/docs/agents-and-tools/computer-use](https://docs.anthropic.com/en/docs/agents-and-tools/computer-use)
- Compute Use 实现示例：[https://github.com/anthropics/anthropic-quickstarts/tree/main/computer-use-demo](https://github.com/anthropics/anthropic-quickstarts/tree/main/computer-use-demo)
- Compute Use 开源实现：[https://github.com/e2b-dev/open-computer-use](https://github.com/e2b-dev/open-computer-use)、[https://github.com/showlab/computer_use_ootb](https://github.com/showlab/computer_use_ootb)
...
当然也可以完全通⁠过编程自主开发智能体，之前我们‌通过 Spring AI 创建​的恋爱大师 APP 就已经是个‎智能体了，包含了大模型决策、记‌忆能力、知识库集成和工具调用。
...
在我们开发超级智能体前，可以先学习下优秀的开源项目。下面以 [OpenManus 项目](https://github.com/FoundationAgents/OpenManus) 为例，鱼皮会带大家从 0 开始阅读项目源码，学到超级智能体实现方式的同时，帮助大家掌握快速学习开源项目的方法。

💡 友情提⁠示，鱼皮带大家分析的源‌码是 2025 年 5​ 月 16 日的，后续‎源码可能会持续更新，重‌点在于学习分析源码的套路。
...
![[Pasted image 20260507135218.png]]
### AI 智能体核心实现
...
![[Pasted image 20260507135317.png]]
...
![[Pasted image 20260507135502.png]]
![[Pasted image 20260507135517.png]]
...
当然也可以通过编写 Prompt 实现，比如 Prompt 中提到 “如果你认为需要向人类寻求帮助，输出结果中需要包含 [ASK_USER]{寻求帮助的具体问题}”，并且检查每一条 AI 给出的消息，如果包含了 ASK_USER 标记，就通过系统控制台和用户交互。
