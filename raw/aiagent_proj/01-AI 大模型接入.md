...
- 掌握大模型开发工作流
![[Pasted image 20260507130722.png]]
...
- LangChain4j 支持的大模型对比：[https://docs.langchain4j.dev/integrations/language-models/](https://docs.langchain4j.dev/integrations/language-models/)
- Spring AI 大模型对比文档：[https://docs.spring.io/spring-ai/reference/1.0/api/chat/comparison.html](https://docs.spring.io/spring-ai/reference/1.0/api/chat/comparison.html)
## 二、接入 AI 大模型
...
在 IDEA 中新建项目，选择 Spring Initializr 模板，注意需要确保 Server URL 为 [https://start.spring.io/](https://start.spring.io/)。
...
4）启动项目，访问 [http://localhost:8123/api/doc.html](http://localhost:8123/api/doc.html) 能够看到接口文档，可以测试调用接口：
## 四、程序调用 AI 大模型
...
6）安装运行成功后，可以在终端打字和大模型对话：访问 [http://localhost:11434](http://localhost:11434/)，能够看到模型正常运行：
